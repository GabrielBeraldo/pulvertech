...
#define sensorInterrupt 1  // 1 = digital pin 3
#define SensorIn 3//A1
#define timeoutFlux 500
#define FluxCalibrateButton A4
#define FluxLed A3
...
void FluxSetup()
{
    ...
    attachInterrupt(sensorInterrupt, FluxTime, CHANGE);
}
...
double FluxCalibrate()
{
    ...
    */
    ...
    LiterPP = (1.00 / pulseCount) * pow(10, 6); //need to store on eeprom;
