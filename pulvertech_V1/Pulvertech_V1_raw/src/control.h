...
class ControllerClass{
    ...
    float P_FRACTION=0.0; //#define P_FRACTION 2//0.8         //0.0 - 10.0 (0.3)
    float I_FRACTION=0.0; //#define I_FRACTION 0.08//0.08         //0.0 - 10.0 (0.3)
    float D_FRACTION=0.0; //#define D_FRACTION 6//6.0         //0.0 - 10.0 (4.0)
    ...
    float proportional(){return P_FRACTION;};
    void proportional(float proportional){P_FRACTION=proportional;};
...
void ControllerClass::setup(float PVal, float IVal, float DVal)
{
